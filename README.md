...
2. Add a reference to `mini-climate-card-bundle.js` inside your `ui-lovelace.yaml`.
  ...
  ```yaml
  resources:
    - url: /local/mini-climate-card-bundle.js?v=1.2.9
      type: module
  ```
...
2. Grab `mini-climate-card-bundle.js`
  ...
  ```console
  $ wget https://github.com/artem-sedykh/mini-climate-card/releases/download/v1.2.9/mini-climate-card-bundle.js
  ```
